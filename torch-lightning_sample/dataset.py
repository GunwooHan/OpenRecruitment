...
import pandas as pd
from pandas_streaming.df import connex_split
...
class ImageBaseDataset(Dataset):
    ...
    def __init__(self, data_dir, mean=(0.560, 0.524, 0.501), std=(0.233, 0.242, 0.245), transform=None, val_ratio=0.2):
    ...
    def __getitem__(self, index):
        ...
        return image_transform, torch.tensor(multi_class_label)
...
class TestDataset(Dataset):
    def __init__(self, img_paths, resize, mean=(0.560, 0.524, 0.501), std=(0.233, 0.242, 0.245)):
